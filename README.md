...
## 📥 Downloads (v1.2 - Stable) / دانلودها (نسخه پایدار ۱.۲)
...
| :--- | :--- | :--- |
| **v1.2** | 🛠️ **Installer (Setup)** / نصب‌کننده | [Download `.exe` Setup](https://github.com/hmovaghari/AppLuncher/releases/download/w.1.2/AppLuncher.1.2.Setup.exe) |
| **v1.2** | 🚀 **Portable (ZIP)** / نسخه پرتابل | [Download `.zip` Portable](https://github.com/hmovaghari/AppLuncher/releases/download/w.1.2/AppLuncher.1.2.zip) |
